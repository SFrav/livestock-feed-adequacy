...
MERtotalYr_WS_Sud_cattle <- lapp(lv[[c(1,4)]], fun = function(cattle, livelihood) { #!Including pregnancy
  ifelse(livelihood !=8, #8 is the Sudanian
...
lvTLU <- lapp(lv[[1:3]], fun = function(cattle, sheep, goat){(cattle*1)+(sheep*0.15)+(goat*0.15)})
lvstIntake_TLU_MJ <- lapp(lvTLU, fun = function(TLU){((TLU)*(250 * 0.02 * 8 * 365))}, filename = 'SpatialData/outputs/Lvst_intake_TLU_MJ_2015min.tif', overwrite = T) #, filename = 'D:/outIntake.tif', overwrite = T
...
}, filename = 'SpatialData/outputs/Lactation_intake_TLU_MJ_2015_min.tif', overwrite = T)
...
}, filename = 'SpatialData/outputs/Lactation_intake_model_MJ_2015_min.tif', overwrite = T)
...
#Assume 8Mj ME per kg of liveweight. Assume 8 Mj ME and 10% DM for every litre of milk 
lvTLU <- lapp(lv[[1:3]], fun = function(cattle, sheep, goat){(cattle*1)+(sheep*0.15)+(goat*0.15)})
lvstIntake_TLU_MJ <- lapp(lvTLU, fun = function(TLU){((TLU)*(250 * 0.02 * 8 * 365))}, filename = 'SpatialData/outputs/Lvst_intake_TLU_MJ_2015max.tif', overwrite = T) #, filename = 'D:/outIntake.tif', overwrite = T
lactationIntake_TLU_MJ <- lapp(lv[[1:4]], fun = function(cattle, sheep, goats, livelihood) { 
  (8 * 0.1 * cattle * param_ME$value[param_ME$Variable=="HS" & param_ME$name == "Cow" & param_ME$Region == "Sah"]*
     param_ME$value[param_ME$Variable=="TMY" & param_ME$name == "Cow" & param_ME$Region == "Sah"])+
    (8 * 0.1 * sheep * param_ME$value[param_ME$Variable=="HS" & param_ME$name == "Sheep" & param_ME$Region == "Sah"]*
    ...
    (8 * 0.1 * goats * param_ME$value[param_ME$Variable=="HS" & param_ME$name == "Goat" & param_ME$Region == "Sah"]*
       param_ME$value[param_ME$Variable=="TMY" & param_ME$name == "Goat" & param_ME$Region == "Sah"])
}, filename = 'SpatialData/outputs/Lactation_intake_TLU_MJ_2015_max.tif', overwrite = T)
...
}, filename = 'SpatialData/outputs/Lactation_intake_model_MJ_2015_max.tif', overwrite = T)
