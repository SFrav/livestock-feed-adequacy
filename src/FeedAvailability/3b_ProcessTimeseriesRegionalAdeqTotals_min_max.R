...
lv2014 <- sum((cattleIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2014 & FAOlvstPop$Item == "Cattle"])), (shoatsIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2014 & FAOlvstPop$Item == "Shoats"])), na.rm = T)
lv2015 <- sum(cattleIntake_model_MJ_2015, shoatsIntake_model_MJ_2015, na.rm = T)
lv2016 <- sum(cattleIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2016 & FAOlvstPop$Item == "Cattle"]), shoatsIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2016 & FAOlvstPop$Item == "Shoats"]), na.rm = T)
lv2017 <- sum(cattleIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2017 & FAOlvstPop$Item == "Cattle"]), shoatsIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2017 & FAOlvstPop$Item == "Shoats"]), na.rm = T)
lv2018 <- sum(cattleIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2018 & FAOlvstPop$Item == "Cattle"]), shoatsIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2018 & FAOlvstPop$Item == "Shoats"]), na.rm = T)
lv2019 <- sum(cattleIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2019 & FAOlvstPop$Item == "Cattle"]), shoatsIntake_model_MJ_2015 + (cattleIntake_model_MJ_2015*FAOlvstPop$PcChange[FAOlvstPop$Year == 2019 & FAOlvstPop$Item == "Shoats"]), na.rm = T)
...
colnames(tsSum) <- c("NAME_1", "lvstReqMEmin_2014", "lvstReqMEmin_2015", "lvstReqMEmin_2016", "lvstReqMEmin_2017", "lvstReqMEmin_2018", "lvstReqMEmin_2019", "feedME_min_2014", "feedME_min_2015", "feedME_min_2016", "feedME_min_2017", "feedME_min_2018", "feedME_min_2019")

tsSum$adeqMin_2014 <- tsSum$feedME_min_2014 / tsSum$lvstReqMEmin_2014
tsSum$adeqMin_2015 <- tsSum$feedME_min_2015 / tsSum$lvstReqMEmin_2015
tsSum$adeqMin_2016 <- tsSum$feedME_min_2016 / tsSum$lvstReqMEmin_2016
tsSum$adeqMin_2017 <- tsSum$feedME_min_2017 / tsSum$lvstReqMEmin_2017
tsSum$adeqMin_2018 <- tsSum$feedME_min_2018 / tsSum$lvstReqMEmin_2018
tsSum$adeqMin_2019 <- tsSum$feedME_min_2019 / tsSum$lvstReqMEmin_2019
...
shoatsIntake_model_MJ_2015 <- raster('SpatialData/outputs/shoatsMER_MJ_2015_min.tif')#Min feed requirement will give max adequacy
