...
##iSPAMAnimalDigestCropFrac <- resample(iSPAMAnimalDigestCropFrac, stLU$LUcrops300, method = "bilinear")
#iSPAMAnimalDigestCropFrac <- crop(iSPAMAnimalDigestCropFrac, extent(stLU$LUcrops300))
#iSPAMAnimalDigestCropFrac <- mask(iSPAMAnimalDigestCropFrac, stLU$LUcrops300)

#iSPAMAnimalDigestCropFrac <- overlay(iSPAMnonFeedArea, iSPAMnonFeedArea, fun = function(nonFeed, total){1 - (nonFeed / total)})
#iSPAMAnimalDigestCropFrac <- 1 - (iSPAMnonFeedArea / iSPAMnonFeedArea)
