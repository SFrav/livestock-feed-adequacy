...
#cropMEmean <- resample(cropMEmean, feedCropBurn, method = "ngb") #Uncomment for within region pixel variability
#cropMEmin <- resample(cropMEmin, feedCropBurn, method = "ngb")
#cropMEmax <- resample(cropMEmax, feedCropBurn, method = "ngb")
#writeRaster(cropMEmean, 'SpatialData/intermediate/cropMEmean.tif', overwrite = T)
#writeRaster(cropMEmin, 'SpatialData/intermediate/cropMEmin.tif', overwrite = T)
#writeRaster(cropMEmax, 'SpatialData/intermediate/cropMEmax.tif', overwrite = T)
...
#cropME_HI_utilmean <- resample(cropME_HI_utilmean, feedCropBurn, method = "ngb") #Uncomment for within region pixel variability
#cropME_HI_utilmin <- resample(cropME_HI_utilmin, feedCropBurn, method = "ngb")
#cropME_HI_utilmax <- resample(cropME_HI_utilmax, feedCropBurn, method = "ngb")
#writeRaster(cropME_HI_utilmean, 'SpatialData/intermediate/cropME_HI_utilmean.tif', overwrite = T)
#writeRaster(cropME_HI_utilmin, 'SpatialData/intermediate/cropME_HI_utilmin.tif', overwrite = T)
#writeRaster(cropME_HI_utilmax, 'SpatialData/intermediate/cropME_HI_utilmax.tif', overwrite = T)
